...
public class UpdateRecord implements Command {
	...
	public Protocol execute(List<Object> o) {
		...
		try {
			...
			HashMap<String, String> records = (HashMap<String, String>) this.protocol
					.getRequestInformation().getTags();
			DNSUtil.updateRecord(domain, hostName, records);
	...
	private ExceptionProtocol generateException(String code, String type,
		...
		exceptionInformation.addTags("Command", "UpdateRecord");
