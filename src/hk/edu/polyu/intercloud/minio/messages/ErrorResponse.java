...
import hk.edu.polyu.intercloud.minio.main.ErrorCode;
...
public class ErrorResponse extends XmlEntity {
	...
	public String getString() {
		return "ErrorResponse(" + "code=" + code + ", " + "message=" + message + ", " + "bucketName=" + bucketName
				+ ", " + "objectName=" + objectName + ", " + "resouce=" + resource + ", " + "requestId=" + requestId
				+ ", " + "hostId=" + hostId + ")";
	}
}
