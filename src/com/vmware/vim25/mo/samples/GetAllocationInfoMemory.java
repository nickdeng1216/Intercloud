...
public class GetAllocationInfoMemory {
	public double GetAllocationInfoMemory_execute() throws Exception {
		...
		for (int i = 0; i < rps.length; i++) {
			...
			// available
			System.out
					.println(rp.getRuntime().memory.unreservedForVm / 1024 / 1024);
			// reserved
			System.out
					.println(rp.getRuntime().memory.reservationUsed / 1024 / 1024);
	...
	public static void main(String[] args) throws Exception {
		GetAllocationInfoMemory a = new GetAllocationInfoMemory();
		System.out.print(a.GetAllocationInfoMemory_execute());
